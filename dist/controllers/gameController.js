...
const createGame = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const blackCards = yield (0, cardDecks_1.getCardsFromPacks)(selectedBlackCardPacks, 'black');
        const whiteCards = yield (0, cardDecks_1.getCardsFromPacks)(selectedWhiteCardPacks, 'white');
...
const startNextRound = (game) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (retries > 0) {
        try {
            ...
            const notification = {
                title: 'New Round',
                message: `Round ${updatedGame.round} has started. ${(_a = updatedGame.players.find(p => p.id === updatedGame.cardCzar)) === null || _a === void 0 ? void 0 : _a.name} is the new Card Czar.`
            };
            io.to(game._id).emit('notification', notification);
            ...
            game = (yield Game_1.default.findById(game._id));
        }
    }
});
...
const createPack = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield newPack.save();
        res.status(201).json(transformMongoDocument(newPack));
    }
    catch (error) {
